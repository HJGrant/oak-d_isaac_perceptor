...
def generate_launch_description():
    ...
    print("##### OAK-D Config File Path: " + os.path.join(my_oakd_launch_prefix, "config", "rgbd.yaml" + "#####"))
    ...
    declared_arguments = [
        ...
        DeclareLaunchArgument(
            "rviz_config",
            default_value=os.path.join(my_oakd_launch_prefix, "config", "rviz", "rgbd.rviz"),
        ),
